          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                _GreyInfo(
                  '통신판매업 : 제 000-서울 강남-0000 호',
                ),
                SizedBox(
                  height: 4,
                ),
                _GreyInfo(
                  '주소 : 서울특별시 강남구 강남 0000',
                ),
                SizedBox(
                  height: 16,
                ),
                ...
                Row(children: [
                  _GreyInfo('제휴문의 : '),
                  _HighlightInfo('e-mail@gmail.com'),
                ]),
                SizedBox(
                  height: 4,
                ),

                //텍스트가 넓이를 넘어갔을때 안 짤리도록
                Wrap(
                  runSpacing: 4,
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _GreyInfo('이메일 : '),
                        _HighlightInfo('f-market@hgh.com'),
                      ],
                    ),
                  ],
                ),
            ...
            Text(
              'F마켓에서 판매되는 상품 중에는 F마켓에 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다. 마켓플레이스(오픈마켓) 상품의 경우 컬리는 통신판매중개자로서 통신판매의 당사자가 아닙니다. F마켓은 해당 상품의 주문, 품질, 교환/환불 등 의무와 책임을 부담하지 않습니다.',
