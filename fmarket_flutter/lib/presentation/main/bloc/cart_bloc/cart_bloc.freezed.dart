...
mixin _$CartState {
  ...
  int get totalPrices => throw _privateConstructorUsedError;
...
class _$CartStateImpl implements _CartState {
  ...
  @override
  String toString() {
    return 'CartState(status: $status, error: $error, productInfo: $productInfo, quantity: $quantity, totalPrices: $totalPrices)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalPrices, totalPrices) ||
                other.totalPrices == totalPrices));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, status, error, productInfo, quantity, totalPrices);
...
abstract class _CartState implements CartState {
  factory _CartState(
      ...
      final ProductInfo productInfo,
      final int quantity,
      final int totalPrices}) = _$CartStateImpl;
