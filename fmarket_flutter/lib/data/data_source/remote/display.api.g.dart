...
class _DisPlayApi implements DisPlayApi {
  ...
  Future<ResponseWrapper<List<ViewModelDto>>> getMenuModuleByTabId(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ResponseWrapper<List<ViewModelDto>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ResponseWrapper<List<ViewModelDto>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<ViewModelDto>(
                  (i) => ViewModelDto.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
